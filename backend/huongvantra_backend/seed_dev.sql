...
VALUES
  ...
  ('20000000-0000-0000-0000-000000000012',
   ...
   '{"Khối lượng":"1kg"}',
   350000, 500000, 20, 500, 0, 0, 1, NULL,
   1000, NULL, 0, '2026-01-01 00:00:00'),
  ...
  ('20000000-0000-0000-0000-000000000013',
   ...
   '{"Khối lượng":"1kg"}',
   140000, 210000, 40, 1500, 0, 0, 1, NULL,
   1000, NULL, 0, '2026-01-01 00:00:00');
...
VALUES
  ...
  ('30000000-0000-0000-0000-000000000012',
   '10000000-0000-0000-0000-000000000012',
   '20000000-0000-0000-0000-000000000012',
   'Kg', 1, 500000, NULL, 0, 1, 0, '2026-01-01 00:00:00'),

  -- NL-OLONG-1KG ─ Kg (base, không bán lẻ)
  ('30000000-0000-0000-0000-000000000013',
   '10000000-0000-0000-0000-000000000013',
   '20000000-0000-0000-0000-000000000013',
   'Kg', 1, 210000, NULL, 0, 1, 0, '2026-01-01 00:00:00');
...
-- TRA-SEN-250G ← trà xanh thô 0.23kg + hoa sen khô 0.05kg
INSERT INTO ProductVariantBomLines
  (ProductVariantId, MaterialId, Quantity, IsDeleted, CreatedAt)
SELECT
  '20000000-0000-0000-0000-000000000002',
  '10000000-0000-0000-0000-000000000011',
  0.23, 0, '2026-01-01 00:00:00'
WHERE NOT EXISTS (
  SELECT 1 FROM ProductVariantBomLines
...
-- TRA-OL-100G ← lá trà ô long thô 0.10kg
INSERT INTO ProductVariantBomLines
  (ProductVariantId, MaterialId, Quantity, IsDeleted, CreatedAt)
SELECT
  '20000000-0000-0000-0000-000000000003',
  '10000000-0000-0000-0000-000000000013',
  0.10, 0, '2026-01-01 00:00:00'
WHERE NOT EXISTS (
  SELECT 1 FROM ProductVariantBomLines
...
-- TRA-OL-250G ← lá trà ô long thô 0.25kg
INSERT INTO ProductVariantBomLines
  (ProductVariantId, MaterialId, Quantity, IsDeleted, CreatedAt)
SELECT
  '20000000-0000-0000-0000-000000000004',
  '10000000-0000-0000-0000-000000000013',
  0.25, 0, '2026-01-01 00:00:00'
WHERE NOT EXISTS (
  SELECT 1 FROM ProductVariantBomLines
...
VALUES
  ...
  ('20000000-0000-0000-0000-000000000011', 'NL-TRAXANH-1KG',1000,  0, 150, 50, 50,  0, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
  ('20000000-0000-0000-0000-000000000012', 'NL-HOASEN-1KG', 1000,  0,  60, 20, 20,  0, '2026-01-01 00:00:00', '2026-01-01 00:00:00'),
  ('20000000-0000-0000-0000-000000000013', 'NL-OLONG-1KG',  1000,  0, 120, 40, 40,  0, '2026-01-01 00:00:00', '2026-01-01 00:00:00');
...
VALUES
  ...
  ('70000000-0000-0000-0000-000000000006',
   ...
   'Trà xanh thô 1kg', 150, 200, 120000, '2026-01-01 08:00:00', '2026-01-01 08:00:00'),

  ('70000000-0000-0000-0000-000000000007',
   '60000000-0000-0000-0000-000000000001',
   '20000000-0000-0000-0000-000000000012', 'NL-HOASEN-1KG',
   'Hoa sen khô 1kg', 60, 100, 350000, '2026-01-01 08:00:00', '2026-01-01 08:00:00'),

  ('70000000-0000-0000-0000-000000000008',
   '60000000-0000-0000-0000-000000000001',
   '20000000-0000-0000-0000-000000000013', 'NL-OLONG-1KG',
   'Lá trà ô long thô 1kg', 120, 180, 140000, '2026-01-01 08:00:00', '2026-01-01 08:00:00'),
...
--   TRA-OL-250G    Trà Ô Long Cao Sơn 250g   giá 330.000   tồn CH:  35 / kho: 120
--   HTRA-DHB-100G  Hồng Trà Đại Hồng Bào 100g giá 220.000  tồn CH:  30 / kho: 140
--
-- Nguyên liệu (chỉ kho tổng):
--   NL-TRAXANH-1KG  Trà xanh thô 1kg      kho: 150
--   NL-HOASEN-1KG   Hoa sen khô 1kg       kho:  60
--   NL-OLONG-1KG    Lá trà ô long thô 1kg kho: 120
--
-- BOM (lệnh sản xuất):
--   TRA-SEN-100G ← 0.09 kg NL-TRAXANH + 0.02 kg NL-HOASEN
--   TRA-SEN-250G ← 0.23 kg NL-TRAXANH + 0.05 kg NL-HOASEN
--   TRA-OL-100G  ← 0.10 kg NL-OLONG
--   TRA-OL-250G  ← 0.25 kg NL-OLONG
--
-- Bảng giá:
