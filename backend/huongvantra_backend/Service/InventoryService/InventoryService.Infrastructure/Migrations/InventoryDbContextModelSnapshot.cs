...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.ProductionOrder", b =>
                {
                    ...
                    b.Property<bool>("IsAutoGeneratedForShelfReplenishment")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid?>("SourceStockAdjustmentRequestId")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("SourceStockAdjustmentRequestItemId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("SourceStockAdjustmentRequestId");

                    b.HasIndex("SourceStockAdjustmentRequestItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.StockAdjustmentRequestItem", b =>
                {
                    ...
                    b.Property<Guid?>("AutoProductionOrderId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("AutoProductionOrderId")
                        .IsUnique();
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.StockDeductQueueItem", b =>
                {
                    ...
                    b.Property<int?>("WarehouseTransferQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.SupplierReturnRequest", b =>
                {
                    ...
                    b.Property<string>("DefectReasonCode")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.WarehouseDailyReportSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("ExpiringBatchCount30Days")
                        .HasColumnType("int");

                    b.Property<int>("LowStockSkuCount")
                        .HasColumnType("int");

                    b.Property<int>("OpenCarryCount")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SentByRoleName")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
                    ...
                    b.Property<int>("TotalWarehouseQuantity")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusinessDate", "SentAtUtc");

                    b.ToTable("WarehouseDailyReportSubmissions", (string)null);
                });
            ...
            modelBuilder.Entity("InventoryService.Domain.Entities.StockAdjustmentRequestItem", b =>
                {
                    b.HasOne("InventoryService.Domain.Entities.ProductionOrder", "AutoProductionOrder")
                        .WithOne()
                        .HasForeignKey("InventoryService.Domain.Entities.StockAdjustmentRequestItem", "AutoProductionOrderId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("AutoProductionOrder");
