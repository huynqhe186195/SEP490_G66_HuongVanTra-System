...
public class ProductDeletionRequestConfiguration : IEntityTypeConfiguration<ProductDeletionRequest>
{
    public void Configure(EntityTypeBuilder<ProductDeletionRequest> builder)
    {
        builder.ToTable("ProductDeletionRequests");
        ...
        builder.Property(x => x.DeletedProductIdsJson).HasColumnType("LONGTEXT");
