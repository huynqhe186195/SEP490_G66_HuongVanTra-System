...
public class ProductVariantConfiguration : IEntityTypeConfiguration<ProductVariant>
{
    public void Configure(EntityTypeBuilder<ProductVariant> builder)
    {
        ...
        builder.Property(v => v.IsPurchasable).HasDefaultValue(false);
        builder.Property(v => v.CanBeBomComponent).HasDefaultValue(false);
        builder.Property(v => v.CanUseInCustom).HasDefaultValue(false);
        builder.Property(v => v.CanHaveBom).HasDefaultValue(false);
