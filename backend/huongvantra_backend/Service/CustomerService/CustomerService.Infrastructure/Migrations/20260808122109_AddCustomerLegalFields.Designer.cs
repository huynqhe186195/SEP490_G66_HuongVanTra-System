...
namespace CustomerService.Infrastructure.Migrations
{
    ...
    [Migration("20260808122109_AddCustomerLegalFields")]
    partial class AddCustomerLegalFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CustomerService.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateOnly?>("LegalRepresentativeIdIssueDate")
                        .HasColumnType("date");

                    b.Property<string>("LegalRepresentativeIdIssuePlace")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
