...
-- CREATE DATABASE IF NOT EXISTS `hvt_product_db` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- CREATE DATABASE IF NOT EXISTS `hvt_user_db`    CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
