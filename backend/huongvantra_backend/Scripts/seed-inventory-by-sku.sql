...
VALUES
  ...
  ('NL-XUC-TRE', 'NL', 'Xúc trà tre (NL)', 20000, 0, 0, 200),
  ('NL-XUC-DONG-GO', 'NL', 'Xúc trà đồng cán gỗ (NL)', 25000, 0, 0, 150),
  ('NL-XUC-GO-NAU', 'NL', 'Xúc trà gỗ nâu (NL)', 45000, 0, 0, 120),
  ('NL-XUC-VANG-DEN', 'NL', 'Xúc trà vàng chuôi đen (NL)', 120000, 0, 0, 80),
  ('NL-XUC-CHUOI-RONG', 'NL', 'Xúc trà chuôi rồng (NL)', 55000, 0, 0, 100),
  ('NL-TONG-THUY-TINH', 'NL', 'Tống thủy tinh trong (NL)', 250000, 0, 0, 60),
  ('NL-TONG-NAU-DO', 'NL', 'Tống nâu đỏ (NL)', 60000, 0, 0, 80),
  ('NL-TONG-QUAI-GO', 'NL', 'Tống quai gỗ to (NL)', 180000, 0, 0, 50),
...
VALUES
  ...
  ('c1000005-0000-4000-8000-000000000005', 'HVT-LOT-NL-XUC-TRE-1', 'NL-XUC-TRE', 'HTX Thủ công dụng cụ trà', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000006-0000-4000-8000-000000000006', 'HVT-LOT-NL-XUC-DONG-GO-1', 'NL-XUC-DONG-GO', 'HTX Thủ công dụng cụ trà', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000007-0000-4000-8000-000000000007', 'HVT-LOT-NL-XUC-GO-NAU-1', 'NL-XUC-GO-NAU', 'HTX Thủ công dụng cụ trà', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000008-0000-4000-8000-000000000008', 'HVT-LOT-NL-XUC-VANG-DEN-1', 'NL-XUC-VANG-DEN', 'HTX Thủ công dụng cụ trà', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000009-0000-4000-8000-000000000009', 'HVT-LOT-NL-XUC-CHUOI-RONG-1', 'NL-XUC-CHUOI-RONG', 'HTX Thủ công dụng cụ trà', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000010-0000-4000-8000-000000000010', 'HVT-LOT-NL-TONG-THUY-TINH-1', 'NL-TONG-THUY-TINH', 'Xưởng gốm sứ Bát Tràng', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000011-0000-4000-8000-000000000011', 'HVT-LOT-NL-TONG-NAU-DO-1', 'NL-TONG-NAU-DO', 'Xưởng gốm sứ Bát Tràng', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
  ('c1000012-0000-4000-8000-000000000012', 'HVT-LOT-NL-TONG-QUAI-GO-1', 'NL-TONG-QUAI-GO', 'Xưởng gốm sứ Bát Tràng', '2028-08-28 00:00:00', 'Phase B seed — NL dụng cụ trà', 'Warehouse'),
...
VALUES
  ...
  ('d1000005-0000-4000-8000-000000000005', 'c1000005-0000-4000-8000-000000000005', 'NL-XUC-TRE', 200, 20000),
  ('d1000006-0000-4000-8000-000000000006', 'c1000006-0000-4000-8000-000000000006', 'NL-XUC-DONG-GO', 150, 25000),
  ('d1000007-0000-4000-8000-000000000007', 'c1000007-0000-4000-8000-000000000007', 'NL-XUC-GO-NAU', 120, 45000),
  ('d1000008-0000-4000-8000-000000000008', 'c1000008-0000-4000-8000-000000000008', 'NL-XUC-VANG-DEN', 80, 120000),
  ('d1000009-0000-4000-8000-000000000009', 'c1000009-0000-4000-8000-000000000009', 'NL-XUC-CHUOI-RONG', 100, 55000),
  ('d1000010-0000-4000-8000-000000000010', 'c1000010-0000-4000-8000-000000000010', 'NL-TONG-THUY-TINH', 60, 250000),
  ('d1000011-0000-4000-8000-000000000011', 'c1000011-0000-4000-8000-000000000011', 'NL-TONG-NAU-DO', 80, 60000),
  ('d1000012-0000-4000-8000-000000000012', 'c1000012-0000-4000-8000-000000000012', 'NL-TONG-QUAI-GO', 50, 180000),
