  ...
  useEffect(() => {
    ...
    const appliedPromotionScopeText = (() => {
        ...
        if (scopeType === "CATEGORY") {
            ...
            const configuredNames = (appliedPromotion.categoryScopes ?? []).map((scope) => scope.categoryName || scope.categoryId).filter(Boolean);
            return configuredNames.length ? `Áp dụng cho danh mục: ${configuredNames.join(", ")}` : "Áp dụng theo danh mục";
        }
