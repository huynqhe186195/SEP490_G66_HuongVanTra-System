...
export function mapWarehouseBatch(row) {
  ...
  return {
    ...
    sourceReferenceId: row.sourceReferenceId ?? row.SourceReferenceId ?? null,
    sourceReferenceCode: row.sourceReferenceCode ?? row.SourceReferenceCode ?? '',
    location: row.location ?? row.Location ?? 'Warehouse',
    parentBatchId: row.parentBatchId ?? row.ParentBatchId ?? null,
    sourceBatchId: row.sourceBatchId ?? row.SourceBatchId ?? null,
