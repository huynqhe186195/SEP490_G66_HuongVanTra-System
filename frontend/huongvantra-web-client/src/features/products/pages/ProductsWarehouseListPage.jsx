          ...
          <table className="min-w-full divide-y divide-slate-100 text-left text-sm">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className={TABLE_HEAD}>Tồn kho tổng</th>
                    ...
                    <tr key={product.id} className={product.isDeleted ? 'bg-slate-50/80 opacity-75' : undefined}>
                      ...
                      <td className={TABLE_CELL}>
                        {skuSummary.count ? (
                          ...
                          <Link to={`/products/${product.id}/edit`} className="text-xs font-semibold text-[#356647] hover:underline">
                      ...
                      <td className={TABLE_CELL} title={stockSummary.title || undefined}>
                        <span
                          className={`font-semibold ${
                            stockSummary.isOut ? 'text-[#b42318]' : stockSummary.isLow ? 'text-[#7e5700]' : 'text-[#356647]'
                          }`}
                        >
                          {stockSummary.label}
                        </span>
