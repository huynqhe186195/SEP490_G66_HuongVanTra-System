...
const ROLE_MODULE_MAP = {
  ...
  warehouse: ['products', 'product_creation_requests', 'stock_deduct_ops', 'stock_adjustment_ops', 'stock_transfer_ops', 'inventory', 'inventory_statistics', 'warehouse_daily_report'],
  accountant: [
    'orders',
    'customers',
    'contracts',
